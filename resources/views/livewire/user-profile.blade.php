<div class="space-y-6 py-4">
    <!-- Header -->
    <div class="bg-white/80 backdrop-blur-md border border-gray-100 rounded-2xl px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
        <div class="flex items-center gap-3 md:gap-4 w-full sm:w-auto">
            <a href="{{ route('listings') }}" class="hover:bg-gray-100 p-2 rounded-full transition-colors">
            ...
            <div class="flex items-center gap-2 md:gap-3">
                ...
                <div>
                    <div class="flex items-center gap-2 md:gap-3">
                        <h1 class="text-sm md:text-xl font-black text-slate-800 tracking-tight uppercase leading-none truncate max-w-[150px] md:max-w-none">{{ $user->name }}</h1>
                        @if($user->rank)
                    ...
                    <p class="text-[9px] md:text-[11px] text-gray-500 mt-0.5 md:mt-1 font-mono font-bold uppercase">{{ $user->phone }} • Mã CTV: {{ $user->invite_code }}</p>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
        <div class="bg-white p-4 sm:p-6 rounded-[20px] sm:rounded-[24px] border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all">
            ...
            <p class="text-[9px] sm:text-[10px] text-gray-400 font-black uppercase tracking-widest mb-1">Hoa hồng</p>
        ...
        <div class="bg-white p-4 sm:p-6 rounded-[20px] sm:rounded-[24px] border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all">
            ...
            <p class="text-[9px] sm:text-[10px] text-gray-400 font-black uppercase tracking-widest mb-1">Tiền thưởng</p>
        ...
        <div class="bg-white p-4 sm:p-6 rounded-[20px] sm:rounded-[24px] border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all">
            ...
            <p class="text-[9px] sm:text-[10px] text-gray-400 font-black uppercase tracking-widest mb-1">Giao dịch</p>
        ...
        <div class="bg-white p-4 sm:p-6 rounded-[20px] sm:rounded-[24px] border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all">
            ...
            <p class="text-[9px] sm:text-[10px] text-gray-400 font-black uppercase tracking-widest mb-1">Tuyển dụng</p>
    ...
    <!-- Sales & Invites Tables -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- Sales List -->
        <div class="bg-white rounded-[24px] sm:rounded-[32px] border border-gray-100 shadow-sm overflow-hidden flex flex-col">
            <div class="px-5 sm:px-8 py-4 sm:py-6 border-b border-gray-50 flex items-center justify-between">
                <h3 class="text-sm sm:text-base font-black text-slate-800 uppercase tracking-tight flex items-center gap-2 sm:gap-3">
                    <span class="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-orange-100 text-orange-600 flex items-center justify-center">
        ...
        <div class="bg-white rounded-[24px] sm:rounded-[32px] border border-gray-100 shadow-sm overflow-hidden flex flex-col">
            <div class="px-5 sm:px-8 py-4 sm:py-6 border-b border-gray-50 flex items-center justify-between">
                <h3 class="text-sm sm:text-base font-black text-slate-800 uppercase tracking-tight flex items-center gap-2 sm:gap-3">
                    <span class="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-indigo-100 text-indigo-600 flex items-center justify-center">
